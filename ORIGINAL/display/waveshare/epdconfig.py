...
Standard Waveshare HAT pin assignments (BCM numbering — physically fixed by the HAT):
  RST  = 17   DC = 25   CS = 8 (SPI CE0)   BUSY = 24

RST uses GPIO 17. The project default relay_pin is GPIO 27, which avoids
this conflict. Do not change relay_pin to 17 when an e-ink HAT is installed.
